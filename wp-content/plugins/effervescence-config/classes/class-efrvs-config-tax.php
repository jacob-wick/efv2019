...
class EFRVS_Config_Tax {
  ...
  {
    $labels = array(
      'name'                       => _x( 'Other Participants', 'Taxonomy General Name', EFRVS_CONFIG_TDOMAIN ),
      'singular_name'              => _x( 'Participant', 'Taxonomy Singular Name', EFRVS_CONFIG_TDOMAIN ),
      'menu_name'                  => __( 'Other Participants', EFRVS_CONFIG_TDOMAIN ),
      'all_items'                  => __( 'All Other Participants', EFRVS_CONFIG_TDOMAIN ),
      'parent_item'                => __( 'Parent Participant', EFRVS_CONFIG_TDOMAIN ),
      'parent_item_colon'          => __( 'Parent Participant:', EFRVS_CONFIG_TDOMAIN ),
      'new_item_name'              => __( 'New Participant', EFRVS_CONFIG_TDOMAIN ),
      'add_new_item'               => __( 'Add Participant', EFRVS_CONFIG_TDOMAIN ),
      'edit_item'                  => __( 'Edit Participant', EFRVS_CONFIG_TDOMAIN ),
      'update_item'                => __( 'Update Participant', EFRVS_CONFIG_TDOMAIN ),
      'view_item'                  => __( 'View Participant', EFRVS_CONFIG_TDOMAIN ),
      'separate_items_with_commas' => __( 'Separate participants with commas', EFRVS_CONFIG_TDOMAIN ),
      'add_or_remove_items'        => __( 'Add or remove participants', EFRVS_CONFIG_TDOMAIN ),
      'choose_from_most_used'      => __( 'Choose from the most used', EFRVS_CONFIG_TDOMAIN ),
      'popular_items'              => __( 'Popular participants', EFRVS_CONFIG_TDOMAIN ),
      'search_items'               => __( 'Search participants', EFRVS_CONFIG_TDOMAIN ),
      'not_found'                  => __( 'Not Found', EFRVS_CONFIG_TDOMAIN ),
      'no_terms'                   => __( 'No items', EFRVS_CONFIG_TDOMAIN ),
      'items_list'                 => __( 'Other Participant list', EFRVS_CONFIG_TDOMAIN ),
      'items_list_navigation'      => __( 'Other Participant list navigation', EFRVS_CONFIG_TDOMAIN ),
    );
    $args = array(
      'labels'                     => $labels,
      'hierarchical'               => false,
